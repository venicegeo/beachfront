...
declare namespace olx {
    ...
    interface OverlayOptions {
        ...
        /**
         * (Experimental) Set the overlay id. The overlay id can be used with the ol.Map#getOverlayById method.
         */
        id?: number | string
...
declare namespace ol {
    ...
    class Overlay extends ol.Object {
        ...
        /**
         * (Experimental) Get the overlay identifier which is set on constructor.
         * @returns Id.
         */
        getId(): number | string;
    ...
    namespace control {
         ...
         */
        type ScaleLineUnits = string;

        class Attribution extends ol.control.Control {
        }

        abstract class Control extends ol.Object {
        ...
        class MousePosition extends ol.control.Control {
            ...
            setCoordinateFormat(coordinateFormat: ol.CoordinateFormatType): void;
    ...
    namespace format {
        ...
        class GeoJSON extends ol.format.JSONFeature {
             ...
             * @returns Feature
             */
            readFeature(source: Document | Node | GlobalObject | string, options?: olx.format.ReadOptions): ol.Feature;
             ...
             * @returns Features
             */
            readFeatures(source: Document | Node | GlobalObject | string, options?: olx.format.ReadOptions): Array<ol.Feature>;
             ...
             * @returns Geometry
             */
            readGeometry(source: Document | Node | GlobalObject | string, options?: olx.format.ReadOptions): ol.geom.Geometry;
             ...
             */
            writeFeatureObject(feature: ol.Feature, options?: olx.format.WriteOptions): olx.GeoJSONFeature;
             ...
             * @returns GeoJSON object
             */
            writeFeaturesObject(features: Array<ol.Feature>, options?: olx.format.WriteOptions): olx.GeoJSONFeatureCollection;
             ...
             * @returns GeoJSON object
             */
            writeGeometryObject(geometry: ol.geom.Geometry, options?: olx.format.WriteOptions): olx.GeoJSONGeometry | olx.GeoJSONGeometryCollection;
        }
    ...
    namespace style {
         ...
         */
        interface StyleFunction { (feature: ol.Feature, resolution?: number): ol.style.Style | Array<ol.style.Style> }
    }
     ...
     */
    interface FeatureStyleFunction { (resolution: number): Array<ol.style.Style> | ol.style.Style }
